...
<head>
    ...
    <title>Saisie Comportement</title>
...
<body>
            ...
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="text-center">Votre comportement enregistrée avec succès.</p>
                    </div>
    ...
    <a type="button" class="btn btn-dark btn-rounded" href="{{ route('comportement') }}"> <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 text-center"> 
                <p class="title">Saisie Comportement</p>
            </div>
            <div class="col-md-8">
                <br/>
                <form action="{{ route('storeComportement') }}" method="POST" style="width: 80%; margin: 0 auto;">
                @csrf
                    <div class="container">
                        <div class="row justify-content-center">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label"><b>Formateur : </b></label>
                                <select id="selectList" name="Formateur" class="form-select" >
                                    @foreach ($formateurs as $formateur)
                                        <option value="{{$formateur->IdForm}}">{{$formateur->Formateur}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div  class="mb-3">
                                <label for="" class="form-label"><b>Motif : </b></label>
                                <textarea name="Motif" cols="30" rows="10" class="form-control"></textarea>
                                @error('Motif')
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label"><b>Sanction : </b></label>
                                <select id="selectList" name="TypeComportement" class="form-select" >
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" id="date"  name="DateComportement" class="form-control">
