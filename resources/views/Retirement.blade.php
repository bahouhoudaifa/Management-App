...
<head>
    ...
    <title>Saisie Retirements</title>
</head>
...
<body>
    <x-bar>
        <div>
            <br>
            <h1 class="text-center" style="font: small-caps bold 24px/1 sans-serif; font-size: 50px" > <u>Saisie Retirement</u> </h1>
            <div class="limiter">
                                ...
                                <table>
                                    <thead>
                                        <tr class="row100 head">
                                            ...
                                            <th class="cell100 column5">Retirement</th>
                                        </tr>
                                    </thead>
                                </table>
                            </div>
                                        ...
                                        @foreach ($stagiaires as $stagiaire)
                                            <tr class="row100 body">
                                                ...
                                                <td class="cell100 column5" style="padding-left: 40px;">
                                                    <a style="text-decoration: none ;" href="{{ route('saisieretirement',$stagiaire->idStag) }}" class="link">
